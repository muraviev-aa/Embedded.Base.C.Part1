...
* <strong> 8.c </strong> Рекурсивная функция. Выводит все числа от A до B включительно, в порядке возрастания, если A < B, или в порядке убывания в противном случае. Исходные данные: два целых числа через пробел;
