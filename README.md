...
* <strong> 7.c </strong> Считываем массив из 10 элементов и выполняем инверсию отдельно для 1-ой и 2-ой половин массива. Меняем считанный массив и печатаем его одним циклом;
