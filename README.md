...
<strong> &#128194; hw6</strong> Буферный ввод/вывод. Функции.
...
* 6.c Зёрна разложены на клетках шахматной доски. На каждой следующей клетке удваивается количество зёрен. Определить количество зерен на указанной клетке.
