...
* <strong> 19.c </strong> Рекурсивная функция, которая считывает строку со стандартного потока ввода и возвращает целое число - количество символов 'a' в данной строке. Исходные данные: строка состоящая из английских букв, пробелов и знаков препинания. В коне строки символ '.';
