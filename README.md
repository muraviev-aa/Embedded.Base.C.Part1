...
* 7.c Функция, которая переводит число N из десятичной системы счисления в P-ичную систему счисления. Исходные данные: два целых числа, N ≥ 0 и 2 ≥ P ≥ 9;
...
* 10.c Функция, которая печатает все простые множители числа. Исходные данные: целое положительное число;
